const games = [
    ...
    { title: "Grain Rot",
      ...
      released: "Yes!",
      genre: ["Action", "Indie", "Simulation"],
      link: "steam://openurl/https://store.steampowered.com/app/4450620/GRAIN_ROT/",
      cover: "images/Grain Rot.jpg",
    },
    // Beat for Speed
    { title: "Beat for Speed",
      suggestedBy: "Liam",
      released: "No!",
      genre: ["Casual", "Indie"],
      link: "steam://openurl/https://store.steampowered.com/app/4430260/Beat_For_Speed/",
      cover: "images/Beat for Speed.jpg",
    },
    ...
    { title: "The Mound: Omen of Cthulhu",
      ...
      released: "No!",
      genre: ["Action", "Adventure"],
      link: "steam://openurl/https://store.steampowered.com/app/2569760/The_Mound_Omen_of_Cthulhu/",
      cover: "images/The Mound Omen of Cthulhu.jpg",
    },
    // EverRail
    { title: "EverRail",
      suggestedBy: "Cody",
      ...
      link: "steam://openurl/https://store.steampowered.com/app/4134600/EverRail/",
      cover: "images/EverRail.jpg",
    },
    // STALZONE
    { title: "STALZONE",
      suggestedBy: "Cody",
      ...
      link: "steam://openurl/https://store.steampowered.com/app/1818450/STALZONE/",
      cover: "images/STALZONE.jpg",
    },
    // Mall Together
    { title: "Mall Together",
      suggestedBy: "Liam",
      ...
      link: "steam://openurl/https://store.steampowered.com/app/4668890/Mall_Together/",
      cover: "images/Mall Together.jpg",
    },
    // Fading Echo
    { title: "Fading Echo",
      suggestedBy: "Liam",
      released: "Yes!",
      genre: ["Action", "Adventure", "Indie", "RPG"],
      link: "steam://openurl/https://store.steampowered.com/app/2467880/Fading_Echo/",
      cover: "images/Fading Echo.jpg",
    },
    // Dinoblade
    { title: "Dinoblade",
      suggestedBy: "Liam",
      ...
      link: "steam://openurl/https://store.steampowered.com/app/3440070/Dinoblade/",
      cover: "images/Dinoblade.jpg",
    },
    ...
    { title: "Unrailed 2: Back on Track",
      ...
      link: "steam://openurl/https://store.steampowered.com/app/2211170/Unrailed_2_Back_on_Track/",
      cover: "images/Unrailed 2 Back on Track.jpg",
    },
    // Forever Skies
    { title: "Forever Skies",
      suggestedBy: "Liam",
      ...
      link: "steam://openurl/https://store.steampowered.com/app/1641960/Forever_Skies/",
      cover: "images/Forever Skies.jpg",
    },
    // Mistfall Hunter
    { title: "Mistfall Hunter",
      ...
      released: "Yes!",
      genre: ["Action", "Adventure"],
      link: "steam://openurl/https://store.steampowered.com/app/3282300/Mistfall_Hunter/",
      cover: "images/Mistfall Hunter.jpg",
    },
    // Zombutcher: Monster Business Simulator
    { title: "Zombutcher: Monster Business Simulator",
      suggestedBy: "Liam",
      released: "Yes!",
      genre: ["Action", "Indie", "Simulation"],
      link: "steam://openurl/https://store.steampowered.com/app/4039900/ZOMBUTCHER_Monster_Business_Simulator/",
      cover: "images/Zombutcher Monster Business Simulator.jpg",
    },
    // Storage Hunter Simulator
    { title: "Storage Hunter Simulator",
      suggestedBy: "Cody",
      released: "Yes!",
      genre: ["Casual", "Indie", "Simulation"],
      link: "steam://openurl/https://store.steampowered.com/app/1442430/Storage_Hunter_Simulator/",
      cover: "images/Storage Hunter Simulator.jpg",
    },
    // Machine Party
    { title: "Machine Party",
      suggestedBy: "Cody",
      released: "Yes!",
      genre: ["Action", "Indie"],
      link: "steam://openurl/https://store.steampowered.com/app/4108000/Machine_Party/",
      cover: "images/Machine Party.jpg",
    },
    // Tom Clancy's Ghsot Recon Breakpoint
    { title: "Tom Clancy's Ghost Recon Breakpoint",
      suggestedBy: "Cody",
      released: "Yes!",
      genre: ["Action", "Adventure"],
      link: "steam://openurl/https://store.steampowered.com/app/2231380/Tom_Clancys_Ghost_Recon_Breakpoint/",
      cover: "images/Tom Clancys Ghost Recon Breakpoint.jpg",
    },
    // The Dead We Knew: Open World Survival
    { title: "The Dead We Knew: Open World Survival",
      suggestedBy: "Samantha",
      released: "17 September 2026",
      genre: ["Action", "Adventure"],
      link: "steam://openurl/https://store.steampowered.com/app/4890760/THE_DEAD_WE_KNEW_Open_World_Survival/",
      cover: "images/The Dead We Knew Open World Survival.jpg",
    },
    // Mr Trippy
    { title: "Mr Trippy",
      suggestedBy: "Samantha",
      released: "No!",
      genre: ["Casual", "Indie", "Simulation"],
      link: "steam://openurl/https://store.steampowered.com/app/4738460/Mr_Trippy/",
      cover: "images/Mr Trippy.jpg",
    },
    // Aliens Took My Stuff
    { title: "Aliens Took My Stuff",
      suggestedBy: "Blake",
      released: "No!",
      genre: ["Action", "Adventure", "Indie"],
      link: "steam://openurl/https://store.steampowered.com/app/4441950/Aliens_Took_My_Stuff/",
      cover: "images/Aliens Took My Stuff.jpg",
    },
    // Thief Simulator
    { title: "Thief Simulator",
      ...
      released: "Yes!",
      genre: ["Action", "Adventure", "Indie", "Simulation"],
      link: "steam://openurl/https://store.steampowered.com/app/704850/Thief_Simulator/",
      cover: "images/Thief Simulator.jpg",
    },
    // Thief Simulator 2
    { title: "Thief Simulator 2",
      ...
      released: "Yes!",
      genre: ["Action", "Indie", "Simulation"],
      link: "steam://openurl/https://store.steampowered.com/app/1332720/Thief_Simulator_2/",
      cover: "images/Thief Simulator 2.jpg",
    },
    // Thief Simulator 3
    { title: "Thief Simulator 3",
      suggestedBy: "Liam",
      released: "No!",
      genre: ["Action", "Adventure", "Indie", "Simulation"],
      link: "steam://openurl/https://store.steampowered.com/app/3223070/Thief_Simulator_3/",
      cover: "images/Thief Simulator 3.jpg",
    },
    // World War Z
    { title: "World War Z",
      suggestedBy: "Cody",
      released: "Yes!",
      genre: ["Action"],
      link: "steam://openurl/https://store.steampowered.com/app/699130/World_War_Z/",
      cover: "images/World War Z.jpg",
    },
    // Woman Simulator
    { title: "Woman Simulator",
      suggestedBy: "TJ",
      released: "22 Sep 2026!",
      genre: ["Action", "Adventure", "Casual", "Indie", "RPG", "Simulation", "Sports"],
      link: "steam://openurl/https://store.steampowered.com/app/4072240/Woman_Simulator/",
      cover: "images/Woman Simulator.jpg",
    },
    ...
    { title: "The First Descendant",
      ...
      link: "steam://openurl/https://store.steampowered.com/app/2074920/The_First_Descendant/",
      cover: "images/The First Descendant.jpg",
    },
    // The Isle
    { title: "The Isle",
      suggestedBy: "Blake",
      ...
      link: "steam://openurl/https://store.steampowered.com/app/376210/The_Isle/",
      cover: "images/The Isle.jpg",
    },
];
